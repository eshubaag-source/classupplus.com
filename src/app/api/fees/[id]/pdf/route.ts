...
export async function GET(
  ...
  try {
    ...
    let currentY = 245;
    // Row 1: School Fees
    page.drawText('School Fees', { x: 40, y: currentY, size: 9.5, font: fontRegular, color: rgb(17 / 255, 24 / 255, 39 / 255) });
    ...
    // Row 3: Last Year Fees (if present)
    if (hasLastYear) {
      currentY -= 20;
    ...
    // Total Paid row
    const grandTotalRowY = tableBottomY - 22;
    page.drawRectangle({
      x: 30,
      y: grandTotalRowY - 8,
      width: width - 60,
